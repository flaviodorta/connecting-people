  ...
  return (
    <div>
      ...
      >
        ...
        <p className='text-white text-[1.3rem] lg:text-[1.6rem]'>
          O planejamento desempenha um papel fundamental no processo de design,
          pois estabelece as bases para o sucesso do projeto. É nessa fase que
          os objetivos são definidos, os requisitos são analisados e as
          estratégias são traçadas para alcançar o resultado desejado.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className='text-white text-[1.3rem] lg:text-[1.6rem]'>
          ...
          aspectos do design, desde a usabilidade e experiência do usuário até a
